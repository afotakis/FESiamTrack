...
EvalDatasetConfigDict = {
    EvalDatasetType.EC: {"dt": 0.010, "root_dir": "/path/to/ec_subseq"},
    EvalDatasetType.EDS: {"dt": 0.005, "root_dir": "/path/to/eds_subseq"},
}
...
def track(cfg):
    ...
    try:
        ...
        # Fallback: Hydra not initialized yet or edge-case → use CWD
        run_dir = Path.cwd()
    # Log and print in a machine-friendly way for callers to parse
